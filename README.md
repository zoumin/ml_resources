...
32. [Trax](https://trax-ml.readthedocs.io/en/latest/):An end-to-end library for deep learning that focuses on clear code and speed. It is actively used and maintained in the Google Brain team
